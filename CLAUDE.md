...
**--no-verify-jwt 필수 함수**: `generate-saju-answer`, `generate-tarot-answer`, `send-alimtalk`, `generate-weekly-report`, `send-report-alimtalk`, `generate-sitemap`, `generate-upsell-mapping`, `generate-nadaum-analysis`, `mind-talk-chat`, `generate-thumbnail-image`
