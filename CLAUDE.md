...
**주요 통계**: 컴포넌트 72개 | Edge Functions 41개 | 페이지 52개 | shadcn/ui 48개 | 타로 78장
...
**--no-verify-jwt 필수 함수**: `generate-saju-answer`, `generate-tarot-answer`, `send-alimtalk`, `generate-weekly-report`, `send-report-alimtalk`, `generate-sitemap`
