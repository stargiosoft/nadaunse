...
### 행동경제학 기반 전략
1. 손실 회피 (Loss Aversion): 잃는 두려움 자극 - "놓치면 후회"
2. 구체적 숫자 (Specific Numbers): 신뢰도 향상 - "3가지 신호", "90% 확률"
3. 타겟 지목 (Cocktail Party Effect): 내 이야기처럼 - "30대 직장인이라면"
4. 간편성/즉각성 (Simplicity): 낮은 진입장벽 - "딱 3초면"
5. 비교 및 소외 불안 (FOMO): 조바심 유발 - "요즘 또래들은 다 아는"
6. 인정욕구 및 우월감 (Ego Appeal): 특별해지고 싶은 심리 - "상위 1%만 타고난"
