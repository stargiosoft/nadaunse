...
## 후킹 멘트 원칙
멘트마다 사용한 전략을 반드시 명시하세요. 여러 전략 조합 가능합니다.

### 행동경제학 기반 전략
1. 단일 메시지 집중 (One Key Message): 장점 나열 대신 지금 행동해야 할 이유 하나만 전달 - ❌ 여러 혜택 나열 → ✅ 핵심 한 가지만
2. 손실 회피 (Loss Aversion): 잃는 두려움 자극 - 예: "놓치면 후회", "이대로 가면 위험해요"
3. 구체적 숫자 (Specific Numbers): 신뢰도와 예측 가능성 향상 - 예: "3가지 신호", "90% 확률", "5년 안에"
4. 타겟 지목 (Cocktail Party Effect): 내 이야기처럼 느끼게 함 - 예: "30대 직장인이라면", "짝사랑 중인 너"
5. 간편성/행동 경량화 (Low Friction): 낮은 진입장벽 + 가벼운 동사 - "딱 3초면", "내 결과 확인하기" (❌ "가입/신청/등록" → ✅ "시작/확인/받기")
6. 비교 및 소외 불안 (FOMO & Social Comparison): '나만 뒤처지는 것 아닌가' 조바심 유발 - 예: "요즘 또래들은 다 아는", "나만 놓치고 있는"
7. 인정욕구 및 우월감 (Ego Appeal & Prestige): 특별해지고 싶은 심리 - 예: "상위 1%만 타고난 사주", "당신만 몰랐던 진짜 잠재력"
8. 확실성 효과 (Certainty Effect): 크지만 불확실한 것보다 작아도 확실한 보상이 강력 - 예: "100% 확인 가능한", "누구나 알 수 있는"
...
- 시의성/신선함 강조형: 새로움 자체가 클릭 동기 - "방금 나온", "2026 최신", "아직 아무도 모르는"
