                      ...
                      <div className="font-['Pretendard_Variable'] text-[13px] leading-[20px] text-[#525252] tracking-[-0.39px] space-y-3">
                          ...
                          <div>
                            ...
                            <ol className="list-decimal ml-[22.5px]">
                              ...
                              <li>"회원"이란 카카오 또는 구글 로그인을 통해 서비스를 이용하는 자를 의미합니다.</li>
                              <li>"비회원"이란 회원 가입 없이 무료 서비스를 이용하는 자를 의미합니다.</li>
                              <li>"유료 서비스"란 로그인 후 결제하거나 새싹을 사용하여 이용 가능한 프리미엄 콘텐츠를 포함한 모든 서비스입니다.</li>
                              <li>"콘텐츠"란 사주, 타로, 운세 관련 정보, 글, 이미지, 동영상 등 회사가 제공하는 모든 자료를 의미합니다.</li>
                              <li>"새싹"이란 회원이 유료로 구매하거나 회사로부터 무료로 지급받아 서비스 내에서 유료 콘텐츠를 이용하기 위해 사용할 수 있는 전자적 지급수단을 말합니다.</li>
                              <li>"유상 새싹"이란 회원이 결제를 통해 유료로 구매한 새싹을 말합니다.</li>
                              <li>"무상 새싹"이란 이벤트, 프로모션, 보상 등을 통해 회사가 무료로 지급한 새싹을 말합니다.</li>
                            </ol>
                          </div>
                          ...
                          <div>
                            ...
                            <ol className="list-decimal ml-[22.5px]">
                              ...
                              <li>유료 콘텐츠는 로그인을 통해 회원 인증을 거친 후 직접 결제하거나 새싹을 사용하여 이용할 수 있습니다.</li>
                              <li>결제 수단은 카카오페이, 신용카드 등이며, 결제 시스템은 외부 결제 대행사인 '포트원'을 통해 운영됩니다.</li>
                              <li>유료 서비스와 무료 서비스는 서로 다른 방식으로 제공될 수 있으며, 결과 내용이 다를 수 있습니다.</li>
                              <li>새싹의 구매, 적립 및 사용에 관한 사항은 제7조 및 제8조에 따릅니다.</li>
                              <li>새싹 사용 시 무상 새싹이 유상 새싹보다 먼저 차감되며, 같은 종류의 새싹은 유효기간이 임박한 것부터 차감됩니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제7조 [새싹의 구매 및 적립]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              <li>새싹은 회사가 정한 결제 수단(카카오페이, 신용카드 등)을 통해 유료로 구매할 수 있으며, 표시된 결제 금액에는 부가가치세(10%)가 포함되어 있습니다.</li>
                              <li>회사는 이벤트, 프로모션 등을 통해 회원에게 무상 새싹을 지급할 수 있으며, 무상 새싹의 지급 조건 및 사용 조건은 각 이벤트 안내에 따릅니다.</li>
                              <li>새싹은 서비스 내에서 유료 콘텐츠 이용 목적으로만 사용할 수 있으며, 현금으로 환급되거나 다른 회원에게 양도, 매매, 상속, 대여, 담보 등의 목적으로 사용할 수 없습니다. 다만, 제10조에 따른 환불은 예외로 합니다.</li>
                              <li>만 19세 미만의 미성년자가 새싹을 유료 구매하는 경우, 법정대리인의 동의를 얻어야 합니다. 법정대리인의 동의 없이 이루어진 결제는 미성년자 본인 또는 법정대리인이 취소할 수 있습니다. 다만, 미성년자가 법정대리인이 범위를 정하여 처분을 허락한 재산으로 구매한 경우 또는 속임수로써 성년자로 믿게 한 경우에는 취소가 제한됩니다.</li>
                              <li>회사는 새싹의 종류, 가격, 지급 수량 등을 변경할 수 있으며, 변경 사항이 회원에게 불리한 경우 최소 30일 전에 공지합니다.</li>
                              <li>회사는 새싹 구매 시 거래 조건(종류, 가격, 이용 방법, 환불 조건 등)을 명확하게 고지합니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제8조 [새싹의 유효기간 및 소멸]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              <li>유상 새싹의 유효기간은 구매일로부터 5년입니다.</li>
                              <li>무상 새싹의 유효기간은 지급 시 안내한 조건에 따르며, 별도의 안내가 없는 경우 지급일로부터 180일입니다.</li>
                              <li>유효기간이 경과한 새싹은 자동으로 소멸되며, 소멸된 새싹은 복구되지 않습니다.</li>
                              <li>회사는 새싹 소멸 예정일 30일 전까지 회원에게 소멸 예정 사실을 알림톡, 서비스 내 알림 등의 방법으로 통지합니다.</li>
                              <li>새싹에 오류가 발생한 경우, 회원은 오류 발생일로부터 30일 이내에 회사에 정정을 요청할 수 있으며, 회사는 정당한 요청임이 확인된 경우 30일 이내에 정정합니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제9조 [이용자의 의무]</p>
                            ...
                            <ul className="list-disc ml-[22.5px] mb-1">
                              ...
                              <li>매크로, 다중 계정 등 부정한 방법으로 새싹을 구매하거나 적립하는 행위</li>
                              <li>새싹을 현금, 재화 등으로 환전하거나 제3자에게 양도, 매매하는 행위</li>
                            </ul>
                          ...
                          <div>
                            <p className="font-bold mb-1">제10조 [청약 철회 및 환불]</p>
                            <p className="mb-1">1. 유료 콘텐츠의 경우, 콘텐츠 특성상 "이용 즉시 제공"되는 디지털 상품으로 콘텐츠 조회 이력이 있는 경우 환불이 불가능합니다. 회사는 결제 전 콘텐츠의 요약 등 시험사용 기회를 제공하며, 결제 과정에서 "제공 개시 후 청약철회가 제한된다"는 사실을 이용자에게 명확히 고지합니다.</p>
                            <p className="mb-1">2. 다음의 경우에는 유료 콘텐츠의 환불이 가능합니다:</p>
                            <ul className="list-disc ml-[22.5px] mb-1">
                              <li>기술적 오류로 콘텐츠를 제공받지 못한 경우</li>
                              <li>정보 오류로 정상적인 결과가 나오지 않은 경우</li>
                              <li>기타 오류로 정상적인 서비스를 받지 못한 경우</li>
                            </ul>
                            <p className="mb-1">3. 유상 새싹의 청약철회: 회원은 새싹 구매일로부터 7일 이내에 미사용 새싹에 대해 청약철회를 할 수 있습니다. 다만, 구매한 새싹의 일부라도 사용한 경우 사용한 부분에 대해서는 청약철회가 불가능합니다.</p>
                            <p className="mb-1">4. 새싹의 환불: 청약철회 기간(7일) 경과 후에도 유상 새싹의 미사용분에 대해 환불을 요청할 수 있으며, 이 경우 환불 수수료(결제 금액의 10%)를 공제한 금액이 환불됩니다. 다만, 회사의 귀책사유로 인한 경우에는 수수료를 공제하지 않습니다.</p>
                            <p className="mb-1">5. 새싹의 내용이 표시・광고의 내용과 다르거나 계약 내용과 다르게 이행된 경우, 회원은 새싹을 공급받은 날부터 3개월 이내, 그 사실을 안 날로부터 30일 이내에 청약철회를 할 수 있습니다.</p>
                            <p className="mb-1">6. 무상 새싹 및 무상으로 지급받은 콘텐츠는 환불 대상에서 제외됩니다.</p>
                            <p className="mb-1">7. 환불은 회사가 환불 요청을 승인한 날로부터 3영업일 이내에 결제와 동일한 방법으로 처리합니다.</p>
                            <p>8. 환불을 원하는 경우, 고객센터(이메일: stargiosoft2@gmail.com)를 통해 요청할 수 있습니다.</p>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제11조 [지적 재산권]</p>
                            <ol className="list-decimal ml-[22.5px]">
                          ...
                          <div>
                            <p className="font-bold mb-1">제12조 [개인정보 보호]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              ...
                              <li>영업의 양도, 인수, 합병 등으로 개인정보가 이전되는 경우, 회사는 관련 법령에서 정한 절차에 따라 이용자에게 사전 고지하며, 이용자는 개인정보 이전에 대한 동의를 철회할 수 있습니다.</li>
                              <li>이용자는 회사에 제공한 개인정보의 수집과 이용에 대한 동의를 언제든지 철회할 수 있습니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제13조 [서비스 중단]</p>
                            <p className="mb-1">회사는 다음과 같은 경우 서비스의 제공을 일시적으로 중단할 수 있습니다: 시스템 정기 점검 또는 유지보수가 필요한 경우, 천재지변, 통신 장애 등 불가항력적 사유가 발생한 경우, 기타 회사의 판단에 따라 서비스 제공이 어려운 경우</p>
                            <p>서비스가 영구적으로 중단되는 경우, 회사는 중단 예정일 30일 전에 공지하며, 회원이 보유한 유상 새싹의 미사용분에 대해 환불 조치를 합니다. 무상 새싹은 환불 대상에서 제외됩니다.</p>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제14조 [운세 서비스의 한계 및 신뢰성]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              ...
                              <li>운세 콘텐츠는 엔터테인먼트적 목적이며, 진단, 치료, 법률·재정 자문 등의 대체 수단으로 사용해서는 안 되며, 전문적인 상담이 필요한 경우 반드시 해당 분야 전문가와 상의해야 합니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제15조 [서비스 이용제한]</p>
                            ...
                            <p className="mb-1">2. 제한된 이용자는 서비스 이용 정지에 대해 회사에 이의를 제기할 수 있으며, 회사는 이를 검토하여 적절한 조치를 취합니다.</p>
                            <p>3. 이용제한 또는 이용계약 해지 시, 부정한 방법으로 취득한 새싹은 전액 소멸됩니다. 정상적으로 구매한 유상 새싹의 잔액은 환불 처리합니다. 다만, 회원의 고의적인 서비스 악용 또는 법령 위반 행위로 인한 해지의 경우 유상 새싹 환불이 제한될 수 있습니다.</p>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제16조 [회사 리소스 무단 사용에 대한 조치]</p>
                            <ol className="list-decimal ml-[22.5px]">
                          ...
                          <div>
                            <p className="font-bold mb-1">제17조 [시스템 보안 및 해킹 방지]</p>
                            <ol className="list-decimal ml-[22.5px]">
                          ...
                          <div>
                            <p className="font-bold mb-1">제18조 [책임의 제한]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              <li>회사 또는 그 피용자의 고의 또는 중대한 과실이 없는 한, 서비스의 중단, 지연, 오류 등으로 인한 통상 손해 외의 간접·특별 손해에 대해서는 책임을 지지 않습니다.</li>
                              ...
                              <li>본 조의 책임 제한은 제10조(청약 철회 및 환불)에서 정한 회사의 의무에 영향을 미치지 않습니다.</li>
                            </ol>
                          </div>

                          <div>
                            <p className="font-bold mb-1">제19조 [회사의 의무]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              <li>회사는 제13조 및 기타 특별한 사유가 없는 한 이용자가 신청한 서비스를 이용할 수 있도록 합니다.</li>
                          ...
                          <div>
                            <p className="font-bold mb-1">제20조 [준거법 및 관할]</p>
                            <ol className="list-decimal ml-[22.5px]">
                              <li>본 약관은 대한민국 법령에 따라 해석됩니다.</li>
                              <li>서비스와 관련된 분쟁의 관할 법원은 민사소송법 등 관련 법령에 따릅니다.</li>
                              <li>분쟁 발생 시, 우선적으로 회사와 이용자는 원만한 해결을 위해 상호 협력해야 하며, 협의가 되지 않을 경우 법적 절차를 진행할 수 있습니다.</li>
                            </ol>
                          </div>

                          <p className="text-[12px] text-[#999999] mt-4">고객센터: stargiosoft2@gmail.com<br/>시행일: 2026년 3월 ○일</p>
                      </div>
                  </div>
                  </motion.div>
              )}
