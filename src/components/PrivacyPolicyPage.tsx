            ...
            >
              ...
              <div className="font-['Pretendard_Variable:Regular',sans-serif] leading-[23.5px] text-[#5f5f5f] text-[15px] tracking-[-0.3px]">
                ...
                <ul className="list-disc ml-[22.5px] space-y-[4px]">
                  ...
                  <li>(필수) 유료 서비스 이용 및 서비스 알림 발송 / 1) 주문자 정보: 이름, 전화번호, 이메일 2) 사주 정보: 이름, 성별, 생년월일, 양력·음력, 태어난 시각 / 서비스 제공 완료 후 3년 보관 후 파기</li>
                  ...
                  <li>(필수) 서비스 알림 발송 / 전화번호 / 알림톡을 통한 서비스 안내(결제 완료, 콘텐츠 생성 완료, 주간 성향 분석 보고서 등) / 회원 탈퇴 시까지</li>
                </ul>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="font-['Pretendard_Variable:Regular',sans-serif] leading-[23.5px] text-[#5f5f5f] text-[15px] tracking-[-0.3px]">
                ...
                <ol className="list-decimal ml-[22.5px]">
                  ...
                  <li className="mb-0">서비스 제공에 관한 계약 이행 및 요금정산 : 서비스 제공, 대금 결제, 콘텐츠 제공, 맞춤 서비스 제공, 서비스 제공을 위한 본인 식별, 서비스 관련 알림 발송(결제 완료, 콘텐츠 생성 완료, 주간 보고서 발송 등) 등</li>
                  <li className="mb-0">고객 응대 : 고객의 문의에 대한 처리 신원확인, 고객문의사항 확인, 사실조사를 위한 연락·통지, 처리결과 통보 등</li>
                  <li className="mb-0">신규 서비스 개발 및 마케팅에서의 활용 : 신규 서비스 개발 및 맞춤 서비스 제공, 이벤트, 광고성 정보 제공 및 참여기회 제공, 서비스의 유효성 확인, 회원 서비스 이용 통계 파악 등</li>
