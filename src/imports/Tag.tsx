import svgPaths from "./svg-8tqadibmpl";
...
function RemovableTag() {
  return (
    <div className="bg-[#f9f9f9] content-stretch flex items-center mr-[-14px] px-[16px] py-[12px] relative rounded-[99px] shrink-0" data-name="RemovableTag">
      <div aria-hidden="true" className="absolute border border-[#48b2af] border-solid inset-0 pointer-events-none rounded-[99px]" />
      <Container />
    </div>
  );
}
...
function Frame() {
  return (
    <div className="bg-[#ff6678] content-stretch flex items-center mr-[-14px] p-[6px] relative rounded-[999px] shrink-0">
      <Icons />
    </div>
  );
}
...
export default function Tag() {
  return (
    <div className="content-stretch flex items-center pl-0 pr-[14px] py-0 relative size-full" data-name="Tag">
      <RemovableTag />
      <Frame />
    </div>
  );
