import svgPaths from "./svg-6qpre8t1iu";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 text-[#999] text-center w-full" data-name="Container">
      <p className="css-4hzbpn font-['Pretendard_Variable:SemiBold',sans-serif] font-semibold leading-[28.5px] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">저장한 태그가 없어요</p>
