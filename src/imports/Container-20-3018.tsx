import svgPaths from "./svg-mzaxb1u3cp";
...
function Container() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 text-[#b7b7b7] text-center w-full" data-name="Container">
      ...
      <p className="css-4hzbpn font-['Pretendard_Variable:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[14px] tracking-[-0.42px] w-full">태그 하나만 있어도 보고서가 만들어져요</p>
    </div>
  );
}
