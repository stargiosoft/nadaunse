...
function getHeavyScene(): { surface: string; props: string; light: string } {
  return {
    ...
    light: '상업 제품 사진 스튜디오 세팅 — 창문광·자연광 없이 스트로브 단독 조명. 45도 사이드 대형 소프트박스로 팔찌와 슬랩에 방향감 있고 선명한 그림자. 완벽한 화이트 밸런스, 색 캐스트(color cast) 전혀 없음. 탁함·노이즈·뿌연 느낌 없이 크리스프하고 선명. 팔찌 원석 색상 채도 풍부하게. 미디엄 포맷 카메라. 하이엔드 상업 주얼리 카탈로그 사진',
  };
}
