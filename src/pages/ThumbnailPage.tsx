...
function getHeavyScene(): { surface: string; props: string; light: string } {
  return {
    surface: '짙은 차콜 그레이 린넨 또는 딥 그레이 대리석 슬랩 — 따뜻한 언더톤이 감도는 고급스러운 어두운 표면',
    props: '매끈한 검은 조약돌 한두 개만 팔찌 옆에 살짝. 또는 소품 없이 팔찌만',
    light: '소프트한 사이드 스튜디오 조명 — 팔찌를 부드럽게 감싸는 따뜻한 스포트라이트, 자연스러운 그라데이션 섀도우, 중후하고 프리미엄한 분위기. 너무 어둡거나 차갑지 않게, 전체적으로 밝기 30~40% 수준의 차분하고 묵직한 톤',
  };
}
